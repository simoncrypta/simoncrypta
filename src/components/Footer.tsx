...
export const Footer: React.FC = () => {
  return (
    <footer className="text-center py-8 mt-auto">
      <p className="mb-4">From Montréal, Canada 🍁</p>
      <hr className="w-1/2 mx-auto border-gray-700 opacity-50 my-4" />
      <p className="mb-4">
        You can contact me at simon@simoncrypta.dev <br /> for any good reason 🙂
      </p>
      <hr className="w-1/2 mx-auto border-gray-700 opacity-50 my-4" />
      <div className="flex justify-center items-center gap-4 mt-4">
        <a href="https://github.com/simoncrypta/simoncrypta" aria-label="GitHub profile" className="hover:text-accent transition-colors">
        ...
        <a href="https://x.com/simoncrypta" aria-label="X (Twitter) profile" className="hover:text-accent transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 462.799" fill="none">
        ...
        <a href="https://simoncrypta.dev/index.xml" aria-label="RSS feed" className="hover:text-accent transition-colors">
