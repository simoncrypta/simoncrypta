export function Footer() {
  return (
    <footer>
      ...
      <hr />
      <a href="https://github.com/simoncrypta/simoncrypta" aria-label="GitHub profile">
      ...
      <a href="https://x.com/simoncrypta" style={{ marginLeft: '1rem' }} aria-label="X (Twitter) profile">
      ...
      <a href="https://simoncrypta.dev/index.xml" style={{ marginLeft: '1rem' }} aria-label="RSS feed">
